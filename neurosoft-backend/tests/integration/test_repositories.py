...
class TestAppointments:
    ...
    def test_query_by_date(self, in_memory_db):
        ...
        citas_del_dia = in_memory_db.query(AppointmentORM).filter(AppointmentORM.fecha == target_date).all()
