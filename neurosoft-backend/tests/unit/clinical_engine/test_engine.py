...
class TestRangoPuntajeStrategy:
    ...
    def test_spence_ocd_pd3_da_t57(self, loader, ctx_infantil_10):
        ...
        result = PuntajeDirectoATStrategy().calculate(prueba, 3.0, ctx_infantil_10.age.years, ctx_infantil_10.age.months)
...
class TestClinicalEngineIntegration:
    def test_calificacion_protocolo_wisc(self, engine, ctx_infantil_10):
        result = engine.score(
            "test-wisc",
            {"NiWiscDC": 42, "NiWiscSem": 30, "NiWISCIndComVer": 25,
             "NiSpenceOCD": 3, "NiTestPC": 9999},
            ctx_infantil_10,
            "Test WISC",
        )
