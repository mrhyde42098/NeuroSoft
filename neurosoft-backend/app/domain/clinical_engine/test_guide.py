...
WISC_IV_TESTS: list[TestInfo] = [
    ...
    TestInfo(
        ...
        tipo_respuesta="aciertos",
        instruccion_corta=(
            "«Mira el cuadro con el espacio en blanco. Señala la imagen de abajo que va en ese espacio.»"
        ),
        tips_clinicos=(
    ...
    TestInfo(
        ...
        max_pd=38,
        tipo_respuesta="aciertos",
        instruccion_corta=("«Voy a hacerte algunas preguntas. Escucha con atención y responde lo mejor que puedas.»"),
        tips_clinicos=(
    ...
    TestInfo(
        test_id="NiWisFigInc",
        nombre_display="Figuras Incompletas",
    ...
    TestInfo(
        test_id="NiWisPalCon",
        nombre_display="Palabras en Contexto",
...
WISC_IV_INDICES: list[TestInfo] = [
    TestInfo(
        ...
        nombre_display="ICV — Índice Comprensión Verbal",
    ...
    TestInfo(
        ...
        nombre_display="IRP — Índice Razonamiento Perceptual",
    ...
    TestInfo(
        ...
        nombre_display="IMT — Índice Memoria de Trabajo",
    ...
    TestInfo(
        ...
        nombre_display="IVP — Índice Velocidad de Procesamiento",
    ...
    TestInfo(
        test_id="NiWISCTot",
        nombre_display="CIT — CI Total WISC-IV",
...
WAIS_III_TESTS: list[TestInfo] = [
    ...
    TestInfo(
        test_id="AdWAISCC",
        nombre_display="Construcción Cubos",
    ...
    TestInfo(
        test_id="AdSDWais",
        nombre_display="Clave de Números",
    ...
    TestInfo(
        test_id="AdRDI",
        nombre_display="Dígitos Inversos",
...
ENI2_ATENCION: list[TestInfo] = [
    TestInfo(
        test_id="NiTMTA",
        nombre_display="TMT-A (versión infantil)",
        nombre_prueba_completa="Trail Making Test A — Infantil",
        dominio="ATENCION",
        orden_protocolo=1,
        tiempo_limite_seg=150,
        tipo_respuesta="tiempo",
    ...
    TestInfo(
        test_id="NiTMTB",
        nombre_display="TMT-B (versión infantil)",
    ...
    TestInfo(
        test_id="NiTesCE",
        nombre_display="Test Caras — Errores",
...
ESCALAS_NINOS: list[TestInfo] = [
    TestInfo(
        test_id="NiCDI",
        nombre_display="CDI — Depresión Infantil",
    ...
    TestInfo(
        test_id="NiSpenceTo",
        nombre_display="SCAS — Ansiedad Total",
        ...
        tips_clinicos=("Registrar TOTAL y cada subescala por separado. El sistema calcula T-scores por normativa."),
        protocolo_principal="Escalas",
    ),
    TestInfo(
        test_id="NiVin",
        nombre_display="Vineland — Conducta Adaptativa",
    ...
    TestInfo(
        test_id="NiMchat",
        nombre_display="M-CHAT — Autismo temprano",
...
_ALL_TESTS: list[TestInfo] = (
    WISC_IV_TESTS + WISC_IV_INDICES + WAIS_III_TESTS + ENI2_ATENCION + ESCALAS_NINOS + ADULTO_MAYOR_TESTS
)
...
def get_protocol_tests(protocol_name: str, include_optional: bool = False) -> list[TestInfo]:
    ...
    tests = [
        t for t in _ALL_TESTS if t.protocolo_principal == protocol_name and (include_optional or not t.es_opcional)
    ]
