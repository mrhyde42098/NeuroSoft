...
> **Generado:** 2026-06-01 22:35  ·  **Versión del motor:** ?  ·  **Total pruebas en BD:** 173
...
| Test ID | Categoría | Tipo cálculo | N claves | Min | Max | Anomalías |
|---|---|---|---:|---:|---:|---|
| `AdBeck` | screening | clasificacion_fija | 7 | 1619.0 | 1619.0 | cobertura_baja (n=7), valor_maximo_atipico (1619.0) |
...
| `EscKertesz` | screening | clasificacion_fija | 37 | — | — | — |
| `EscLawton` | screening | clasificacion_fija | 9 | — | — | cobertura_baja (n=9) |
| `EscYesavage` | screening | clasificacion_fija | 16 | — | — | — |
| `FluidAnim` | lenguaje | desconocido | 304 | 1.0 | 18.0 | — |
| `FluidP` | lenguaje | desconocido | 288 | 2.0 | 18.0 | — |
| `MMSE` | screening | clasificacion_fija | 31 | — | — | — |
...
| `ViTMTB` | atencion_velocidad | desconocido | 6024 | 2.0 | 18.0 | — |
