...
export const PROTOCOLOS = [
  ...
  {
    id: "eval_wais_adulto_joven",
    nombre: "Evaluación WAIS Adulto Joven — Queja cognitiva laboral",
    area: "neuropsicologia_adulto_joven",
    disciplina: "neuropsicologia",
    descripcion: "Protocolo para adultos 18-45 años con queja de memoria, concentración o rendimiento laboral. Diferencial: ansiedad, depresión, TDAH, TCE, sustancias.",
    nivel_evidencia: "A",
    tiempo_estimado_min: 120,
    pasos: [
      { orden: 1, titulo: "Entrevista y tamizaje afectivo",
        descripcion: "Anamnesis, PHQ-9, GAD-7, C-SSRS si ideación. Descartar cuadro afectivo activo como causa principal.",
        instrumentos: ["PHQ-9", "GAD-7", "C-SSRS"],
        tiempo_min: 30 },
      { orden: 2, titulo: "WAIS-III/IV núcleo",
        descripcion: "Vocabulario, Matrices, Símbolo-Dígito, Dígitos. Calcular índices y discrepancias.",
        instrumentos: ["WAIS núcleo"],
        tiempo_min: 60 },
      { orden: 3, titulo: "Atención y ejecutivo",
        descripcion: "TMT A+B, Stroop, fluidez verbal si sospecha ejecutivo.",
        instrumentos: ["TMT A+B", "Stroop", "Fluidez"],
        tiempo_min: 25 },
      { orden: 4, titulo: "Integración",
        descripcion: "Correlacionar perfil con HC. Si lentificación global con escalas afectivas altas → reevaluar post-tratamiento.",
        instrumentos: ["Juicio clínico"],
        tiempo_min: 15 },
    ],
    referencias: ["Wechsler 2008", "Lezak 2012", "Flanagan 2013"],
  },

  {
    id: "tamizaje_tea_infantil",
    nombre: "Tamizaje TEA Infantil — Derivación ADOS",
    area: "neuropsicologia_infantil",
    disciplina: "neuropsicologia",
    descripcion: "Ruta de sospecha TEA en 3-12 años antes de confirmación con ADOS-2/ADI-R.",
    nivel_evidencia: "B",
    tiempo_estimado_min: 90,
    pasos: [
      { orden: 1, titulo: "Entrevista desarrollo",
        descripcion: "Hitos lenguaje/social, intereses restringidos, sensorialidad, regresión.",
        instrumentos: ["Entrevista padres", "M-CHAT-R si 16-30m"],
        tiempo_min: 30 },
      { orden: 2, titulo: "Observación + WISC/IRP",
        descripcion: "Contacto ocular, reciprocidad, juego. WISC: buscar IRP>ICV con Comprensión/Semejanzas bajas.",
        instrumentos: ["WISC-IV selectivo", "Observación clínica"],
        tiempo_min: 45 },
      { orden: 3, titulo: "Derivación confirmatoria",
        descripcion: "Si sospecha alta → ADOS-2 + equipo multidisciplinar. No diagnosticar solo desde WISC.",
        instrumentos: ["ADOS-2", "ADI-R"],
        tiempo_min: 15 },
    ],
    referencias: ["APA 2013 DSM-5", "Lord et al. ADOS-2"],
  },
];

export const AREAS_PROTOCOLOS = [
  { id: "neuropsicologia_infantil", label: "Neuropsicología Infantil" },
  { id: "neuropsicologia_adulto_joven", label: "Neuropsicología Adulto Joven" },
