...
- Name: pearsonConsent.spec.js >> Aceptación one-time material con copyright (S5.1x) >> Aceptar persiste en localStorage con VERSION_ACUERDO
- Location: e2e\pearsonConsent.spec.js:73:3
