...
- Name: pearsonConsent.spec.js >> Aceptación one-time material con copyright (S5.1x) >> Muestra el diálogo la primera vez que se inicia la app
- Location: e2e\pearsonConsent.spec.js:35:3
