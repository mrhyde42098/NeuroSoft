...
- Name: pearsonConsent.spec.js >> Aceptación one-time material con copyright (S5.1x) >> El checkbox de confirmación es obligatorio para aceptar
- Location: e2e\pearsonConsent.spec.js:52:3
...
```ts
  1   | /**
  2   |  * S5.1x: Tests E2E del flujo de aceptación one-time del material
  3   |  * con copyright Pearson (WISC-IV, WAIS-III).
  4   |  *
  5   |  * Cobertura:
